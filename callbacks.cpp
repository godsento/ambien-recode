...
void callbacks::ConfigLoad1( ) {
	g_config.load( &g_menu.main, XOR( "1.amb" ) );
...
void callbacks::ConfigLoad( ) {
	...
	std::string file   = tfm::format( XOR( "%s.amb" ), config.data( ) );
